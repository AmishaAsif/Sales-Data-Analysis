# Sales Data Analysis
Here is the analysis of the sales data, extracting necessary information about Products and Customers based on a combination of features with a dashboard to review the performance of the company.

- Performed EDA using python
- Extract necessary information about Products and Customers
- Identified key metrics and factors for finding meaningful relationships between attributes
...
- According to the customer segmentation described above, approximately 15% of our clients are high value clients, whereas the majority of our clientele are low value and 
  lost clients
